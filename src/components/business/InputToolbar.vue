...
<template>
  <div class="input-tool">
    <ModelSelector
      ...
      :visible="modelPopoverVisible"
      :container-id="`model_${modelOptionId}`"
      @update:visible="handleModelPopoverVisibleUpdate"
      @model-change="handleModelChange"
      @open="handleModelSelectorOpen"
    />
    <PromptSelector
      :system-prompts="systemPrompts"
      :user-prompts="userPrompts"
      :visible="promptPopoverVisible"
      :container-id="String(optionId)"
      @update:visible="handlePromptPopoverVisibleUpdate"
      @system-prompt-select="handleSystemPromptSelect"
      @user-prompt-select="handleUserPromptSelect"
      @open="handlePromptSelectorOpen"
    />
    <i
      class="iconfont icon-fasong send-button"
      @click="handleSend"
    ></i>
  </div>
</template>
